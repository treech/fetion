package com.chinasofti.rcs.view;
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                tabView = View.inflate(mContext, R.layout.main_tab_left, null);
            } else if (mIconGravity == Gravity.RIGHT) {
                tabView = View.inflate(mContext, R.layout.main_tab_right, null);
            } else if (mIconGravity == Gravity.BOTTOM) {
                tabView = View.inflate(mContext, R.layout.main_tab_bottom, null);
            } else {
                tabView = View.inflate(mContext, R.layout.main_tab_top, null);
            }
            tabView.setTag(i);
            addTab(i, tabView);
        }
